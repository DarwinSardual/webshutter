...
from WebShutterUI_Copy import WebShutterUI
...
class WebShutterUIController:
    ...
    def __initSignals(self):
        ...
        self.webShutterUI.inputTextEdit.setCallback(self.addButtonClicked)
    ...
    def __startThreads(self):
        #start threading
        self.__toRun = True
        stopIconPath = os.path.join(self.dirname, "../images/stop.svg")
        ...
        self.__toRun = False
        playIconPath = os.path.join(self.dirname, "../images/play.svg")
